 ...
 */
    ...
    if($text){
        ...
        echo '<h1>本系统二维码生成API</h1>';
        echo '<hr/>';
        echo '<h4>禁止未经允许调用接口</h4>';
        echo '<p><b>data</b>：二维码内容</p>';
        echo '<p><b>size</b>：二维码大小</p>';
        echo '<hr/>';
        echo '<p><b>html中调用</b>：&lt;img src="http'. (isset($_SERVER['HTTPS']) ? 's://' : '://').$_SERVER['SERVER_NAME']. $_SERVER['REQUEST_URI'].'?data=生成二维码链接&size=100"&gt;</p>';
    }